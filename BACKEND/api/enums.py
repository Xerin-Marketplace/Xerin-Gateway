...
class PermissionCode(str, enum.Enum):
    ...
    seller_pickup_locations_read = "seller_pickup_locations:read"
    seller_pickup_locations_manage = "seller_pickup_locations:manage"
    ...
    seller_order_chat_read = "seller_order_chat:read"
    seller_order_chat_write = "seller_order_chat:write"
    seller_packaging_manage = "seller_packaging:manage"
    seller_payout_accounts_manage = "seller_payout_accounts:manage"
    seller_payout_accounts_verify = "seller_payout_accounts:verify"
...
class PickupJobStatus(str, enum.Enum):
    scheduled = "scheduled"
    assigned = "assigned"
    en_route = "en_route"
    arrived = "arrived"
...
class AdvertisementStatus(str, enum.Enum):
    ...
    "expired" is intentionally not stored. Expiration is derived from ends_at
    so an advertisement disappears automatically at the exact configured time
    without requiring a background job to mutate its row.
    """
...
class AdvertisementPlacement(str, enum.Enum):
    ...
    hero_side_bottom = "hero_side_bottom"
    homepage_banner = "homepage_banner"
    category_banner = "category_banner"
    search_banner = "search_banner"


class AdvertisementBillingType(str, enum.Enum):
    fixed = "fixed"
    cpc = "cpc"
    cpm = "cpm"
