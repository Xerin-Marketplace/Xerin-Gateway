...
for router in (
    ...
    seller_fulfillment.router,
    seller_inventory.router,
    seller_pickup_locations.router,
    map_locations.router,
    delivery_integration.router,
    delivery_verification.router,
    partner_api.management_router,
    partner_api.partner_router,
    products.router,
    promotions.router,
    cart.router,
    commissions.router,
    marketplace_settings.router,
    logistics.router,
    logistics_wallets.router,
    finance.router,
    seller_lifecycle.router,
    wallets.router,
    refunds.router,
    orders.router,
    payments.router,
